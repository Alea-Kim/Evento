					...
					<div class="col-md-12">
						...
						<div class="iso-section wow fadeIn" data-wow-delay="0.6s">
							...
							<ul class="filter-wrapper clearfix">							
								<form action="occSearch.php" method="post" role="form">
									<div class="col-md-4 col-sm-4 wow fadeIn" data-wow-delay="0.3s">
									<input type="text" placeholder="Search for Connections" name="ConnectInt" class="form-control">
								</div>
							...
							<div class="iso-box-section">
								<?php
									$interest = pg_escape_string($_POST['ConnectInt']);
									$sql = "SELECT name, user_acc_name FROM user_account, user_field WHERE field LIKE '%" . $interest . "%' AND user_field.user_acc_name = user_account.username AND is_approved='t'";
									...
									while ($row = pg_fetch_array($result)) {
										echo "<div><a href='profile.php?username=$row[1]'> <p style='font-size:18px;'>" . $row[0] . " </p></a></div>";								
										$flag = 1;
									}
