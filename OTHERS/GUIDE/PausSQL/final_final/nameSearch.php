					...
					<div class="col-md-12">
						...
						<div class="iso-section wow fadeIn" data-wow-delay="0.6s">
							...
							<ul class="filter-wrapper clearfix">							
								<form action="nameSearch.php" method="post" role="form">
									<div class="col-md-4 col-sm-4 wow fadeIn" data-wow-delay="0.3s">
									<input type="text" placeholder="Search for Connections" name="ConnectName" class="form-control">
								</div>
							...
							<div class="iso-box-section">
								<?php
									...
									$sql = "SELECT name, username FROM user_account where name LIKE '%" . $Name . "%' AND is_approved='t'";
