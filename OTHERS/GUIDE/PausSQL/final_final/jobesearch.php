					...
					<div class="col-md-12">
						...
						<div class="iso-section wow fadeIn" data-wow-delay="0.6s">
							...
							<div class="iso-box-section">
								<?php
									$JobTitle = pg_escape_string($_POST['jobTitle']);
									$sql = "SELECT job_name FROM job_vacancy WHERE job_name LIKE '%" . $JobTitle . "%' AND is_approved = 't'";
									...
									while ($row = pg_fetch_array($result)) {
										echo "<div><a href='job.php?job_name=$row[0]'><p style='font-size:18px;'>" . $row[0] . " </p> </a> </div>";						
										$flag = 1;
									}
