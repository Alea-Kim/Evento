...
<head>
	<meta charset="utf-8">
	<title>A M A L G A M A T E | Add Field of Interest</title>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="wow bounceIn">
						<h2 class="wow bounceIn"> FIELD OF INTEREST </h2>
						<hr>
					</div>
					<div class="iso-section wow fadeIn" data-wow-delay="0.6s">
						<form action="interestNotice.php" method="post" role="form">
							<div style="margin:auto; margin-bottom:10px; width:40%" class="wow fadeIn" data-wow-delay="0.3s">
								<input type="text" placeholder="Field of Interest" name="interest" class="form-control" required="" />
							</div>
