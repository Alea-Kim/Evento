			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="iso-section wow fadeIn" data-wow-delay="0.6s">
						<form action="postNotice.php" method="post" role="form">
							<div style="margin:auto; margin-bottom:10px; width:40%" class="wow fadeIn" data-wow-delay="0.3s">
								<input type="text" placeholder="Job Name" name="job_name" class="form-control" required="" />
							</div>
							<div style="margin:auto; margin-bottom:20px; width:40%" class="wow fadeIn" data-wow-delay="0.3s">
								<input type="text" placeholder="Job Description" name="job_description" class="form-control" required="" />
							</div>
