						...
						<div class="iso-section wow fadeIn" data-wow-delay="0.6s">
							...
							<ul class="filter-wrapper clearfix">							
								<form action="occSearch.php" method="post" role="form">
									...
									<input type="text" placeholder="Search for Connections" name="ConnectOct" class="form-control">
								</div>
							...
							<div class="iso-box-section">
								<?php
									$job = pg_escape_string($_POST['ConnectOcc']);
									$sql = "SELECT name, user_acc_name FROM user_account, user_job where job_name LIKE '%" . $job . "%' AND user_job.user_acc_name = user_account.username AND is_approved='t'";
