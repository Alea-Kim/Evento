			...
			<div class="row">
				<div class="col-md-12">
					<div class="wow bounceIn">
						<h2 class="wow bounceIn"> PROFILE UPDATED!</h2>
						<hr>
					</div>
					<div class="iso-section wow fadeIn" data-wow-delay="0.6s">						
						<?php
							...
							$bday = date('Y-m-d', strtotime(str_replace('-', '/', $bday)));
							$number = pg_escape_string($_POST['number']);
							$address = pg_escape_string($_POST['address']);
							$college = pg_escape_string($_POST['college']);
							$high_educ_attained = pg_escape_string($_POST['high_educ_attained']);
							$objective = pg_escape_string($_POST['objective']);

							$query = "UPDATE user_account SET name='$name', email='$eAdd', birthday='$bday', mobile_number='$number', complete_address='$address', college='$college', highest_educ_attained='$high_educ_attained', objective='$objective' where username='$Username'";
