...
<head>
	<meta charset="utf-8">
	<title>A M A L G A M A T E | Add Degree</title>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="wow bounceIn">
						<h2 class="wow bounceIn"> DEGREE </h2>
						<hr>
					</div>
					<div class="iso-section wow fadeIn" data-wow-delay="0.6s">
						<form action="degreeNotice.php" method="post" role="form">
							<div style="margin:auto; margin-bottom:10px; width:40%" class="wow fadeIn" data-wow-delay="0.3s">
								<input type="text" placeholder="Degree" name="degree" class="form-control" required="" />
							</div>
